...
export default function RestaurantHeader() {
    ...
    return (
        <>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <Link href="/" className="flex items-center space-x-3">
                                ...
                                <span className="font-serif text-xl md:text-2xl font-bold text-black">Savoria</span>
                            </Link>
                        </div>

                        {/* Desktop Navigation */}
                        <nav className="hidden md:flex items-center space-x-8">
                            <Link href="/" className="text-black/80 hover:text-amber-500 transition-colors">
                                Home
                            </Link>
                            <Link href="/menu" className="text-black/80 hover:text-amber-500 transition-colors">
                                Menu
                            </Link>
                            <Link href="/about" className="text-black/80 hover:text-amber-500 transition-colors">
                                About
                            </Link>
                            <Link href="/gallery" className="text-black/80 hover:text-amber-500 transition-colors">
                                Gallery
                            </Link>
                            <Link href="/contact" className="text-black/80 hover:text-amber-500 transition-colors">
                                Contact
                            </Link>
                        </nav>
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <Button className="bg-amber-500 hover:bg-amber-600 text-white border-none">Make a Reservation</Button>
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    {isLoggedIn ? (
                                        <>
                                            ...
                                            <DropdownMenuItem asChild>
                                                <Link href="/account?tab=reservations" className="flex items-center cursor-pointer">
            ...
            <div
                className={`fixed inset-0 bg-white z-50 md:hidden overflow-auto transition-all duration-300 ease-in-out ${isMenuOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-[-100%] pointer-events-none"
                    }`}
            >
                <div className="container mx-auto px-4 py-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="font-serif text-xl font-bold text-black ml-3">Savoria</span>
                        </div>

                        <button className="p-2 text-black" onClick={() => setIsMenuOpen(false)} aria-label="Close menu">
                            <X size={24} />
                        </button>
                    </div>
                        ...
                        <div className="pt-4 border-t border-gray-200">
                            ...
                            {isLoggedIn ? (
                                ...
                                <div className="flex flex-col space-y-2 mt-3">
                                    <Button
                                        variant="outline"
                                        className="justify-start border-black/10 hover:bg-amber-50 hover:text-amber-500 hover:border-amber-500"
                                        onClick={() => {
                                            toggleLoginStatus()
                                            setIsMenuOpen(false)
                                        }}
