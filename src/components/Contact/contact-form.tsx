    ...
    if (formSubmitted) {
        return (
            <div className="bg-muted p-8 rounded-lg text-center animate-fadeIn">
                ...
                <p className="mb-4">Your message has been sent. We'll get back to you as soon as possible.</p>
                <Button
        ...
        <form action={handleFormSubmit} className="space-y-5 animate-fadeIn">
            ...
            <div className="space-y-5">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className={`w-full transition-all ${formErrors.name ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                        required
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className={`w-full transition-all ${formErrors.email ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                        required
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Optional, but helpful for follow-up</p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className={`w-full transition-all ${formErrors.subject ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                        required
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        className={`w-full min-h-[150px] ${formErrors.message ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                        required
            ...
            <div className="flex items-center space-x-2 pt-2">
                ...
                <Label htmlFor="newsletter" className="text-sm text-muted-foreground">
                    Sign up for Savoria's newsletter to receive updates and special offers
                </Label>
            </div>
