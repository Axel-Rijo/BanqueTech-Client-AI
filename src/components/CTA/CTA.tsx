                ...
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                    <div className="space-y-4 text-gray-900 mx-auto max-w-xl">
                        ...
                        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center sm:text-left">
                            Savor the Moment at <span className="text-amber-500">Savoria</span>
                        </h2>
                        <p className="text-gray-600 md:text-xl text-center sm:text-left">
                            Join us at Savoria for an unforgettable dining experience with our chef's special creations and warm,
                            inviting atmosphere.
                        </p>
                        ...
                        <div className="aspect-video relative bg-white p-6 flex flex-col justify-center">
                            <div className="space-y-4">
                                ...
                                <p className="text-sm text-gray-600 text-center sm:text-left">
                                    Subscribe to receive exclusive offers, seasonal menu updates, and invitations to special events at
                                    Savoria.
                                </p>
                                ...
                                <p className="text-xs text-gray-500 text-center sm:text-left">
                                    ...
                                    <Link href="/terms" className="underline underline-offset-2 text-amber-500 hover:text-amber-400">
                                        Terms & Conditions
                                    </Link>
                                </p>
                            </div>
