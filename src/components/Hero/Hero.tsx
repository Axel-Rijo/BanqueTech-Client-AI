      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-4 text-center text-white">
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row">
          <Link href="/reservation">
            <Button
              size="lg"
              className="min-w-[160px] bg-amber-500 text-black hover:bg-amber-600 cursor-pointer"
            >
              Reserve a Table
            </Button>
          </Link>
          <Link href="/menu">
            <Button
              size="lg"
              variant="outline"
              className="min-w-[160px] border-white bg-transparent text-white hover:bg-white/10 cursor-pointer"
            >
              View Menu
            </Button>
          </Link>
